...
TriggerEvent('es:addCommand', 'twt', function(source, args, user)
  table.remove(args, 1)
  TriggerClientEvent('chatMessage', -1, "^0^4tweet^0 (^5@" .. " |" .. GetPlayerName(source) .. "^0)", {30, 144, 255}, table.concat(args, " "))
end, {help = 'Send a tweet. [In Character]'})

TriggerEvent('es:addCommand', 'rt', function(source, args, user)
  table.remove(args, 1)
  TriggerClientEvent('chatMessage', -1, "(^5@" .. GetPlayerName(source) .. "^0) Retweeted a tweet from", {30, 144, 255}, table.concat(args, " "))
end, {help = 'Retweet a tweet. [In Character] Ex: /rt @tsa'})
