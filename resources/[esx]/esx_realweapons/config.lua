...
Config.RealWeapons = {
	...
	{name = 'WEAPON_BAT', 				bone = 24818, x = -0.05, y = -0.15, z = 0.0, xRot = 0.0, yRot = 0.0, zRot = 90.0, category = 'melee', 		model = 'w_me_bat'},
	...
	{name = 'WEAPON_CARBINERIFLE', 		bone = 24818, x = 0.0, y = -0.15, z = 0.0, xRot = 0.0, yRot = 0.0, zRot = 0.0, category = 'assault', 	model = 'w_ar_carbinerifle'},
	...
	{name = 'WEAPON_PUMPSHOTGUN', 		bone = 24818, x = 0.0, y = -0.15, z = -0.1, xRot = 0.0, yRot = 0.0, zRot = 0.0, category = 'shotgun', 	model = 'w_sg_pumpshotgun'},
