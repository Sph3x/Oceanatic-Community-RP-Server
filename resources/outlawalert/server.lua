...
RegisterServerEvent('deathInProgress')
AddEventHandler('deathInProgress', function(street1, street2, veh, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~10-47 of a ~w~"..sex.." ~r~between ~w~"..street1.."~r~ and ~w~"..street2)
end)
