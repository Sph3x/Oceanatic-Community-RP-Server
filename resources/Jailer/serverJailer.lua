...
local jailPassword = "123" --change this password to your liking and don't share it with the criminals ;-)
...
AddEventHandler('chatMessage', function(source, n, message)
    ...
    if(cm[1] == "/jailme") then
		...
		TriggerClientEvent('chatMessage', -1, 'JUDGE', { 255, 0, 0 }, GetPlayerName(source) ..' jailed for '.. jT ..' secs')
