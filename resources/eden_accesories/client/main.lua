...
AddEventHandler('eden_accesories:silencer', function(duration)
	...
	used = used + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in hand or your weapon can not stand silencer."))
		  		
			end
			else
					  		 ESX.ShowNotification(("You have to use all your silencer.")) 
...
AddEventHandler('eden_accesories:flashlight', function(duration)
	...
	used2 = used2 + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in hand or your weapon can not support a flashlight."))
		  		
			end
		else
				  		  ESX.ShowNotification(("You have to use all you flashlights."))
...
AddEventHandler('eden_accesories:grip', function(duration)
	...
	used3 = used3 + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in hand or your weapon can not have a grip."))
				  		  ...
				  		  ESX.ShowNotification(("You have to use all your grips."))
		end
end)
...
AddEventHandler('eden_accesories:yusuf', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used4 < yusuf then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("You have just equipped your Yusuf weapon skin. It will be necessary to re-equip it with every return in town.")) 
		  		 	used4 = used4 + 1
	...
	used4 = used4 + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in hand or your weapon can not stand a luxury look."))
		  		
			end
		else
				  		  ESX.ShowNotification(("You have to use all your Yusuf weapon skins."))
